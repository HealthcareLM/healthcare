...
import { mdiMagnify, mdiMapMarkerOutline, mdiBellOutline } from '@mdi/js';
...
export default function Barra() {
    ...
    return (
        <div className="w-full mb-6 flex justify-between items-center gap-14">
            <h1 className="font-bold text-4xl block mr-8"><span className="font-medium text-xl text-gray_1 block">Hi, Stevan dux</span>{titles[location] || ''}</h1>
