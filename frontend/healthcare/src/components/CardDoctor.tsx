    ...
    <div className="border border-slateBorder rounded-xl p-5 w-full relative">
        <div className="flex after:content-[''] after:block after:absolute after:h-px after:bg-gray_3 after:w-11/12 after:bottom-16 after:left-1/2 after:transform after:-translate-x-1/2">
            <div className="w-16 h-16 rounded-full overflow-hidden">
                <img className="w-full h-full object-cover" src="./doctors/amanda.jpg" alt="foto doctor" />
            </div>
            <div className="ml-4">
                <p className="block text-lg font-medium">Amanda Clara</p>
                <p className="block text-sm font-normal text-gray_2">specialist | 12 years experience</p>
                <div className="block px-3 py-1 bg-azul_claro text-primary text-xs font-normal rounded-3xl w-fit mt-2">Padiatric</div>
            </div>
        </div>
        ...
        <div className="flex mt-8">
            <div className="flex w-full">
                ...
                <div className='flex gap-2 pl-4'>
                    ...
                    <div className="">
                        <p className="block text-sm font-medium">$35</p>
